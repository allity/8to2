...
// 부동(不動 X)(浮動 O)소수점
// .을 유동적으로 움직이면서 표현하는 방법

// 3.1415926535
// 3.1415926535 = 0.31415926535 * 10 = 314.15926535 * 10^-2
// 1) wjdrbghk = 0.31415926535 * 10
// 2) 31415926535 (유효숫자) 1 (지수)

// float 부호(1) 지수(8) 유효숫자(23) = 32비트
// double 부호(1) 지수(11) 유효숫자(52) = 64비트

float attackSpeed = -3.375f; // 4byte
double attackSpeed2 = 123.4123; // 8byte

// ex) -3.375라는 값을 저장
// 1) 2진수 변환 = (3) + (0.375) = 0b11 + 0b0.011 = 0b 11.011
